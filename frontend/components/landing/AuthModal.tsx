...
export const AuthModal = ({ isOpen, onClose, mode, onSwitchMode, onLoginSuccess }: AuthModalProps) => {
  ...
  const handleLogin = () => {
    onLoginSuccess(); // Call this on click
    onClose();
  };
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="space-y-3">
                  <button className="w-full flex items-center justify-center gap-3 bg-white text-black hover:bg-gray-200 font-medium py-2.5 rounded-lg transition-colors">
                    {/* Google SVG Logo */}
