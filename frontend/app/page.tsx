  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="flex flex-col w-full">
        {/* Hero / Input Section */}
        <section className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center p-4">
        ...
        {/* Recent Projects Section - Visible on scroll */}
        <section className="w-full bg-muted/5 py-12 border-t border-border/40">
          <RecentProjects />
        </section>
      </main>
    </div>
